...
public class AprlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "VAR", "VAL", "FUNCTION", "RETURN", "EQUAL", "DOUBLE_EQUAL", "TRIPLE_EQUAL", 
			"NOT_EQUAL", "NOT_DOUBLE_EQUAL", "LANGLE", "RANGLE", "LANGLE_EQUAL", 
			"RANGLE_EQUAL", "LPAREN", "RPAREN", "LSQUARE", "RSQUARE", "LCURLY", "RCURLY", 
			"PERIOD", "COMMA", "COLON", "PLUS", "MINUS", "ASTERISK", "DOUBLE_ASTERISK", 
			"SLASH", "BACKSLASH", "PERCENT", "RIGHT_ARROW", "AND", "DOUBLE_AND", 
			"OR", "DOUBLE_OR", "XOR", "SHL", "SHR", "USHR", "NL", "TRUE", "FALSE", 
			"IntegerLiteral", "FloatLiteral", "CharLiteral", "StringLiteral", "Identifier"
		};
	}
